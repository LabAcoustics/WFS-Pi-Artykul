...
odsłuchu do punktu zachowując naturalną zależność zmiany kierunku docierania dźwięku źródła do słuchacza podczas przemieszczania się w~strefie odsłuchu. Dzięki takiemu rozwiązaniu nie zostają zaburzone psychoakustyczne systemu lokalizacji źródła dźwięku wykorzystujące niewielkie zmiany położenia głowy. Obecnie istnieją różne warianty systemów WFS, projektowane
często z myślą o konkretnym zastosowaniu. Ze względu na wymaganą dużą liczbę kanałów przetwarzania dźwięku oraz dużą liczbę głośników systemy te są drogie i mało popularne. 
...
źródło dźwięku, przekazując falę dalej, a w praktyce tworząc pożądany kształt fali , co pokazuje rysunek
\ref{r:Huygens}.
