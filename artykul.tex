...
\summaryEN{
  The project consists of creating WFS (Wave Field Synthesis) system, that is
  ...
  apprioriate input signal processing, can create the shape of the acoustic
  wave in such a way, that a virtual sound source is created. Modularity of the
  design allows for simultaneous independet processing of big amount of signals
  and sending them to appropriate channels. This allow to extend the system
