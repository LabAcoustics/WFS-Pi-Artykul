...
\begin{figure}[!ht]
  \centering
  \adjincludegraphics[height=.41\textheight,trim={{.15\width} {.03\height} {.15\width} 0},clip]{bitgraphics/real_500Hz.png}
  \adjincludegraphics[height=.41\textheight,trim={{.15\width} 0 {.15\width} {.02\height}},clip]{bitgraphics/virtual_500Hz.png}
