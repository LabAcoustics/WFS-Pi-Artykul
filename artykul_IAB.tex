...
W ramach projektowania systemu między innymi: wybrano rozmiar macierzy
głośnikowej i~dobrano odpowiednie przetworniki oraz dobrano pozostałe elementy
systemu; zaprojektowano algorytm przetwarzania sygnałów; przeprowadzono
...
synchronizacji oraz kontroli systemu napisano w~języku Rust, korzystając z
...
wirtualnego źródła przesyłane są bezprzewodowo przez sieć lokalną, co
oznacza, że system nie odtwarza dźwięku w czasie rzeczywistym, lecz
pozwala na modyfikacje układu przestrzennego i zmniejsza ilość
