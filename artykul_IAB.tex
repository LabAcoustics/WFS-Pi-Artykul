...
opisująca ciśnienie akustyczne w~punkcie umieszczenia każdego głośnika (por. część~\ref{s:algorithm}). To
...
pozwoli na manipulowanie kształtem i~rozmiarem macierzy głośników,
...
Połączenie synchronizujące wykorzystuje piny GPIO, oprogramowanie napisano \linebreak w~języku 
...
że kształt czoła fali jest zbliżony do oczekiwanego, wyznaczonego analitycznie
(por. rys.~\ref{r:symulacja}).
